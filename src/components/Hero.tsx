  ...
  return (
    <section className="relative flex h-[calc(100svh-6rem)] w-full flex-col overflow-hidden">
      <div className="relative flex-1">
        <div className="container-fluid relative z-10 flex h-full flex-col items-start justify-center gap-6">
          ...
          <p className="max-w-xl text-lg leading-8 text-secondary/70">
          ...
          >
            ...
            <span className="bg-secondary group-hover:bg-secondary/90 inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full transition-colors">
