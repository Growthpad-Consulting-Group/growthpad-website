...
export default function NotchCard({
  ...
  return (
    <div
      className={`group transition-all duration-700 ease-out hover:-translate-y-2 hover:scale-[0.98] ${className}`}
    >
      <svg
        viewBox="0 0 455 232"
      ...
      >
        ...
        <path
          ...
          className="transition-all duration-700 ease-out group-hover:[fill-opacity:0.05]"
        />
